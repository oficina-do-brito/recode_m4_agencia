...
public class Passagem implements ICrud {
	...
	@Override
	public void create() {
		this.id = this.passagemDAO
				.save(new Passagem(this.titulo, this.preco, this.tipo, this.idFornecedor, this.idPacoteViagem));
	}
	...
	public void update() {
		if (this.id != null) {
			this.passagemDAO.update(
					new Passagem(this.id, this.titulo, this.preco, this.tipo, this.idFornecedor, this.idPacoteViagem));
		}
